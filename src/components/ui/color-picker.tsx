...
/** Paleta de partida, para não obrigar a saber hexadecimal (o problema do input nativo). */
            ...
            {PALETA.map((cor) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="text-center text-[11px] leading-tight text-muted">{cor.nome}</span>
                </button>
              );
            })}
          </div>
